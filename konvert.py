...
#                      "Введите количесто pln,которые вы хотите конвертировать в usd")
#
...
#     bot.send_message(message.chat.id,
#                      "Введите количесто pln,которые вы хотите конвертировать в rub: ")
#
#     @bot.message_handler(content_types=['text', ])
#     def plnrub(message):
#         r4 = requests.get(
...
import telebot
bot = telebot.TeleBot('5388915598:AAHpezc8UkpCIPIPJzmbwwhU4MqzN4SZCL8')
...
def start(message):
    if message.text == '/start':
        ...
        msg = bot.send_message(message.chat.id, 'Выберите валюту eur или usd', reply_markup=markup)
